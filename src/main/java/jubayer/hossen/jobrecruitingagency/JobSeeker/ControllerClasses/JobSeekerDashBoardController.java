...
public class JobSeekerDashBoardController
{
    ...
    @javafx.fxml.FXML
    public void offersButtonOnAction(ActionEvent actionEvent) {
    }

    @javafx.fxml.FXML
    public void uploadResumeButtonOnAction(ActionEvent actionEvent) {
    }

    @javafx.fxml.FXML
    public void checkApplicationStatusButtonOnAction(ActionEvent actionEvent) {
    }
